...
const I18N = {
  en: {
    ...
    quick_samples_lbl: 'Quick Test Samples:',
    sample_rice_blast: 'Rice Blast Leaf',
    sample_cotton_bollworm: 'Cotton Bollworm',
    sample_wheat_rust: 'Wheat Rust',
    sample_tomato_blight: 'Tomato Blight',
    upload_subtext: 'Supports JPG, PNG, WEBP · Camera capture or Drag & Drop',
    print_pest_report: 'Print / Download Pest Report',
    ...
    quick_scenarios_lbl: 'Quick Scenarios:',
    preset_healthy_rice: 'Healthy Rice',
    preset_drought_wheat: 'Drought Wheat',
    preset_lown_cotton: 'Low N Cotton',
    preset_acidic_potato: 'Acidic Potato',
    preset_sugarcane: 'Sugarcane',
    soil_rich_fertile: 'Rich & Fertile',
    soil_mild_deficit: 'Mild Deficit',
    soil_depleted: 'Depleted',
    badge_high_yield: 'High Yield',
    badge_needs_fert: 'Needs Fertilizer',
    badge_high_risk: 'High Risk',
    opt_soil_alluvial: 'Alluvial (River Soil)',
    opt_soil_black: 'Black (Cotton) Soil',
    opt_soil_red: 'Red Laterite Soil',
    opt_soil_sandy: 'Sandy Soil',
    opt_soil_loamy: 'Loamy Soil',
    opt_soil_clay: 'Clay Soil',
    opt_season_kharif: 'Kharif (Jun–Oct)',
    opt_season_rabi: 'Rabi (Nov–Mar)',
    opt_season_zaid: 'Zaid (Mar–Jun)',
    opt_season_perennial: 'Year-Round',
    opt_water_high: 'High (Irrigated)',
    opt_water_medium: 'Medium (Partial)',
    opt_water_low: 'Low (Rainfed)',
    btn_take_photo: 'Take Photo',
    btn_select_image: 'Select Image',
    opt_crop_rice: 'Rice (వరి)',
    opt_crop_wheat: 'Wheat (గోధుమ)',
    opt_crop_cotton: 'Cotton (పత్తి)',
    opt_crop_maize: 'Maize (మొక్కజొన్న)',
    opt_crop_tomato: 'Tomato (టమాట)',
    opt_crop_groundnut: 'Groundnut (వేరుశనగ)',
    opt_sym_bollworm: 'Holes in bolls / chewed leaves',
    opt_sym_blast: 'Diamond-shaped lesions on leaves',
    opt_sym_aphids: 'Curled leaves & sticky dew',
    opt_sym_rust: 'Brown / orange rust pustules',
    opt_sym_stem_borer: 'Dead heart / dried central shoot',
  ...
  te: {
    ...
    quick_samples_lbl: 'క్విక్ టెస్ట్ ఆకులు:',
    sample_rice_blast: 'వరి అగ్గి తెగులు',
    sample_cotton_bollworm: 'పత్తి కాయ పురుగు',
    sample_wheat_rust: 'గోధుమ తుప్పు తెగులు',
    sample_tomato_blight: 'టమాట మచ్చ తెగులు',
    upload_subtext: 'JPG, PNG, WEBP ఫార్మాట్లు · కెమెరా లేదా డ్రాగ్ & డ్రాప్',
    print_pest_report: 'ప్రింట్ / డౌన్‌లోడ్ రిపోర్ట్',
    ...
    quick_scenarios_lbl: 'త్వరిత ముందస్తు ఎంపికలు:',
    preset_healthy_rice: 'ఆరోగ్యకరమైన వరి',
    preset_drought_wheat: 'రుతుపవనాల గోధుమ',
    preset_lown_cotton: 'తక్కువ N పత్తి',
    preset_acidic_potato: 'ఆమ్ల బంగాళాదుంప',
    preset_sugarcane: 'చెరకు',
    soil_rich_fertile: 'సారవంతమైన నేల',
    soil_mild_deficit: 'మధ్యస్థ లోపం',
    soil_depleted: 'క్షీణించిన నేల',
    badge_high_yield: 'అధిక దిగుబడి',
    badge_needs_fert: 'ఎరువులు అవసరం',
    badge_high_risk: 'అధిక ప్రమాదం',
    opt_soil_alluvial: 'ఒండ్రు నేల (నది ఒడ్డు)',
    opt_soil_black: 'నల్లరేగడి నేల',
    opt_soil_red: 'ఎర్ర నేల',
    opt_soil_sandy: 'ఇసుక నేల',
    opt_soil_loamy: 'మట్టి నేల (Loam)',
    opt_soil_clay: 'జిగురు మట్టి నేల',
    opt_season_kharif: 'ఖరీఫ్ (జూన్-అక్టోబరు)',
    opt_season_rabi: 'రబీ (నవంబరు-మార్చి)',
    opt_season_zaid: 'జైద్ (మార్చి-జూన్)',
    opt_season_perennial: 'ఏడాది పొడవునా',
    opt_water_high: 'అధికం (పూర్తి నీటిపారుదల)',
    opt_water_medium: 'మధ్యస్థం (పాక్షికం)',
    opt_water_low: 'తక్కువ (వర్షాధారం)',
    btn_take_photo: 'ఫోటో తీయండి',
    btn_select_image: 'ఫోటోను ఎంచుకోండి',
    opt_crop_rice: 'వరి (Rice)',
    opt_crop_wheat: 'గోధుమ (Wheat)',
    opt_crop_cotton: 'పత్తి (Cotton)',
    opt_crop_maize: 'మొక్కజొన్న (Maize)',
    opt_crop_tomato: 'టమాట (Tomato)',
    opt_crop_groundnut: 'వేరుశనగ (Groundnut)',
    opt_sym_bollworm: 'కాయ తొలుచు పురుగు / కన్నాలు',
    opt_sym_blast: 'ఆకుపై అగ్గి మచ్చ తెగులు',
    opt_sym_aphids: 'ముడుచుకున్న ఆకులు / పేనుబంక',
    opt_sym_rust: 'తుప్పు మచ్చల తెగులు',
    opt_sym_stem_borer: 'కాండం తొలుచు పురుగు (మొవ్వు చనిపోవడం)',
  ...
  hi: {
    ...
    quick_samples_lbl: 'त्वरित परीक्षण नमूने:',
    sample_rice_blast: 'चावल ब्लास्ट पत्ती',
    sample_cotton_bollworm: 'कपास गुलाबी सूंडी',
    sample_wheat_rust: 'गेहूं रतुआ पत्ती',
    sample_tomato_blight: 'टमाटर अगेती झुलसा',
    upload_subtext: 'JPG, PNG, WEBP समर्थित · कैमरा फोटो या ड्रैग और ड्रॉप',
    print_pest_report: 'रिपोर्ट प्रिंट / डाउनलोड करें',
    ...
    quick_scenarios_lbl: 'त्वरित परिदृश्य:',
    preset_healthy_rice: 'उत्कृष्ट चावल',
    preset_drought_wheat: 'सूखा गेहूं',
    preset_lown_cotton: 'कम N कपास',
    preset_acidic_potato: 'अम्लीय आलू',
    preset_sugarcane: 'गन्ना',
    soil_rich_fertile: 'उपजाऊ मिट्टी',
    soil_mild_deficit: 'मध्यम कमी',
    soil_depleted: 'कमजोर मिट्टी',
    badge_high_yield: 'अधिक उपज',
    badge_needs_fert: 'खाद जरूरी',
    badge_high_risk: 'उच्च जोखिम',
    opt_soil_alluvial: 'जलोढ़ मिट्टी',
    opt_soil_black: 'काली मिट्टी',
    opt_soil_red: 'लाल मिट्टी',
    opt_soil_sandy: 'बलुई मिट्टी',
    opt_soil_loamy: 'दोमट मिट्टी',
    opt_soil_clay: 'चिकनी मिट्टी',
    opt_season_kharif: 'खरीफ (जून-अक्टूबर)',
    opt_season_rabi: 'रबी (नवंबर-मार्च)',
    opt_season_zaid: 'जायद (मार्च-जून)',
    opt_season_perennial: 'वर्ष भर',
    opt_water_high: 'उच्च (सिंचित)',
    opt_water_medium: 'मध्यम (आंशिक)',
    opt_water_low: 'कम (वर्षाधारित)',
    btn_take_photo: 'फोटो खींचें',
    btn_select_image: 'फोटो चुनें',
    opt_crop_rice: 'चावल (Rice)',
    opt_crop_wheat: 'गेहूं (Wheat)',
    opt_crop_cotton: 'कपास (Cotton)',
    opt_crop_maize: 'मक्का (Maize)',
    opt_crop_tomato: 'टमाटर (Tomato)',
    opt_crop_groundnut: 'मूंगफली (Groundnut)',
    opt_sym_bollworm: 'पत्तियों व फलों में छेद (सुंडी)',
    opt_sym_blast: 'पत्तियों पर धब्बे (झुलसा)',
    opt_sym_aphids: 'मुड़ी पत्तियां और चिपचिपा रस (माहू)',
    opt_sym_rust: 'भूरे रतुआ के धब्बे',
    opt_sym_stem_borer: 'तना छेदक कीट (सूखा तना)',
